...
import 'package:salamat/modules/home/view/widgets/more_share_app_btn.dart';
...
import 'package:salamat/modules/downloads/materials/downloaded_material_cubit.dart';
import 'package:salamat/modules/downloads/materials/downloaded_material_screen.dart';
...
class MoreInfoScreen extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> menuItems = [
    ...
    },
    {
      ...
      'onTap': (BuildContext context) {
        pushTo(
          context: context,
          toPage: ContactInfoScreen(infoCubit: infoCubit),
        );
      },
    },
    {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          /// [MORE_SHARE_APP_BUTTON]
          Container(
            transform: Matrix4.translationValues(0, -3.h, 0),
            color: AppColors.SECONDRY,
            width: 1.sw,
            padding: EdgeInsets.symmetric(vertical: 10.h),
            child: Center(child: MoreShareAppBtn(cubit: infoCubit)),
          ),
                  ...
                  children: [
                    Card(
                      ...
                      child: ListTile(
                        ...
                        title: Text(
                          translate(menuItems[index]['title'], context),
                          style: titilliumBold,
                        ),
